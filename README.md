...
The project has [migrated from Yarn Classic](https://yarnpkg.com/migration/overview) and uses Yarn Modern* (which has requires [Corepack](https://nodejs.org/api/corepack.html) to be enabled). [Install yarn if necessary](https://yarnpkg.com/getting-started/install).
